...
<div class="sticky top-0 inset-x-0 z-20 bg-white border-y px-4 sm:px-6 lg:px-8 lg:hidden dark:bg-neutral-800 dark:border-neutral-700">
  ...
  <div id="hs-application-sidebar" class="hs-overlay  [--auto-close:lg]
    ...
    <div class="relative flex flex-col h-full max-h-full">
      <div class="px-6 pt-4 flex items-center">
        <!-- Logo -->
        <a class="flex-none rounded-xl text-xl inline-block font-semibold focus:outline-none focus:opacity-80" href="{{route('dashboard')}}" aria-label="Preline">
            Abbly Chat
  ...
  <!-- End Sidebar -->
    ...
    <div class="w-full pt-100 px-4 sm:px-6 md:px-8 lg:ps-72">
    <!-- Chat Bubble -->
